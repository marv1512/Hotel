...
<style>
     ...
     .button:hover {
          background-color: rgba(28, 78, 216, 0.66);
     }
</style>
     ...
     <div class="container-fluid p-0">
          ...
          <div class="note-body p-5">
               <form action="create-action.php" method="post">
                    ...
                    <input type="text" name="title" id="title" class="input-text p-2 ps-4 w-100" placeholder="Enter Title"> <br>
                    <small class="text-danger"> 
                         <?= $_SESSION['message'] ?? '' ;?> 
                    </small> <br>
                    <label for="note">Note</label> <br>
                    <textarea name="note" id="note" cols="40" rows="10" class=" w-100  p-2 ps-4" placeholder="Enter Note"></textarea> <br> 
                    <small class="text-danger"> 
                         <?= $_SESSION['message'] ?? '' ;?> 
                    </small> <br>
                    <!-- <label for="date">Date</label> <br>
                    <input type="date" name="date" class="date w-100 p-2 ps-4" id="date"><br><br> -->
                    <input type="submit" name="submit" value="Save" class="btn  fw-bold text-white button w-100">
